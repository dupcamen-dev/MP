...
const projects = [
  ...
  { tag: 'PERFUME · CONCEPT', title: 'AVVADON', subtitle: '', color: '#C9A227', desc: 'Luxury fragrance concept store with dark ritual-style UX. Design + frontend only — no backend.', img: '/avvadon-hero.webp', link: 'https://dupcamen-dev.github.io/AVVADON/', caption: 'dupcamen-dev.github.io/AVVADON — design + frontend · 2026' },
];
    ...
    <div className="carousel-card" style={{
      ...
      <div className="card-img" style={{
        ...
        <div style={{
          ...
          background: 'linear-gradient(135deg, rgba(253,253,253,0.15), rgba(253,253,253,0.10))',
...
color: 'var(--ink)', background: 'rgba(253,253,253,0.85)', padding: '5px 10px',
                  borderRadius: 999,
                }}>{p.tag}</span>
      </div>
...
function MobileProjectList() {
  ...
  return (
    <section id="showcase" style={{
      ...
      background: '#fdfdfd', overflow: 'hidden', position: 'relative',
              padding: '24px',
            ...
            <nav style={{
              ...
              {projects.map((_, j) => (
                <button key={j} onClick={() => onCardEnd && onCardEnd(j)} style={{
                  ...
                  background: activeIdx === j ? 'var(--ink)' : '#e8e8e8',
